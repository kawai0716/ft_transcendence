*This project has been created as part of the 42 curriculum by member, member, member, member, sykawai.*
...
|--------|------------------|------------------|
| member | Product Owner (PO) | Requirements definition (18 pts), UI design, Privacy/Terms, GDPR compliance |
| member | Project Manager (PM) | Docker/SSL environment, README, i18n implementation, standard login, OAuth (Google), 2FA (TOTP) |
| member | Technical Lead (TL) | Backend/DB architecture (NestJS, Prisma, API structure) |
| member | Developer A | Pong game engine, WebSocket sync, AI opponent, lag handling |
...
| Major | **Implement real-time features using WebSockets or similar technology:** <br>• Real-time updates across clients. <br>• Handle connection/disconnection gracefully. <br>• Efficient message broadcasting. | 2 | member, sykawai |
| Major | **Allow users to interact with other users:** <br>• A basic chat system. <br>• A profile system (view user information). <br>• A friends system (add/remove friends, see friends list). | 2 | sykawai, member |
| Major | **A public API** with secured API key, rate limiting, documentation, and at least 5 endpoints (GET, POST, PUT, DELETE). | 2 | member |

### IV.2 Accessibility and Internationalization

| Type | Requirement | Points | Owner |
| :--- | :--- | :--- | :--- |
| Minor | **Support for multiple languages (at least 3 languages):** <br>• Implement i18n system. <br>• Language switcher in the UI. <br>• All user-facing text must be translatable. | 1 | member, member |
| Minor | **Right-to-left (RTL) language support:** <br>• Support for at least one RTL language (Arabic, Hebrew, etc.). <br>• Complete layout mirroring and UI adjustments. | 1 | member |

### IV.3 User Management

| Type | Requirement | Points | Owner |
| :--- | :--- | :--- | :--- |
| Major | **Standard user management and authentication:** <br>• Update profile info / Upload avatar. <br>• Add friends and see **online status**. <br>• Profile page displaying information. | 2 | member, sykawai |
...
| Minor | Implement remote authentication with OAuth 2.0 (Google, GitHub, 42, etc.). | 1 | member |

### IV.4 Artificial Intelligence

| Type | Requirement | Points | Owner |
| :--- | :--- | :--- | :--- |
| Major | **Introduce an AI Opponent for games:** <br>• Challenging but simulates human-like behavior. <br>• Compatible with game customization options. <br>• Must be able to explain implementation during evaluation. | 2 | member |

### IV.6 Gaming and user experience

| Type | Requirement | Points | Owner |
| :--- | :--- | :--- | :--- |
| Major | **Implement a complete web-based game (e.g., Pong, Chess):** <br>• Real-time multiplayer live matches. <br>• Clear rules and win/loss conditions. | 2 | member, member |
| Major | **Remote players:** <br>• Enable two players on separate computers in real-time. <br>• Handle network latency and reconnection logic. | 2 | member |

### IV.8 Data and Analytics

| Type | Requirement | Points | Owner |
| :--- | :--- | :--- | :--- |
| Major | **Data export and import functionality:** <br>• Multiple formats (JSON, CSV, XML). <br>• Validation and bulk operations support. | 2 | member |
| Minor | **GDPR compliance features:** <br>• Allow users to request/delete their data. <br>• Export user data in a readable format. | 1 | member |
...
|---------|-----|----------|-------------|
| README | — | member | Fulfill all README requirements |
| Docker & SSL/TLS | — | member | Full environment, HTTPS setup |
| Privacy & Terms | — | member | Privacy Policy, Terms of Service |
| UI design | — | member | Screen flows, UI design |
...
| | Real-time WebSocket | 2 | member |
| | Chat system | 2 | sykawai |
| | Profile system | 2 | member |
| | Friends system | 2 | sykawai |
| | Public API | 2 | member |
| **IV.2** | i18n (3+ languages) | 1 | member |
| | RTL support | 1 | member |
| **IV.3** | Avatar upload | 2 | member |
| | Match history | 1 | sykawai |
| | OAuth 2.0 | 1 | member |
| **IV.4** | AI opponent | 2 | member |
| **IV.6** | Real-time multiplayer | 2 | member |
| | Remote players | 2 | member |
| **IV.8** | Data export/import | 2 | member |
| | GDPR compliance | 1 | member |
